                        ...
                        <div className="pt-[30px] w-full">
                            <div className="grid max-sm:grid-cols-1 max-[1890px]:grid-cols-2 grid-cols-3 gap-y-4 md:gap-y-12">
                                <div className="flex gap-[18px] items-center ">
                                    <div className="size-[60px] 2xl:size-[86px] bg-light-sky-blue rounded-full flex items-center justify-center"><Icons icon="fatherIcon" className="max-2xl:w-[40px]" /></div>
                                    <div className="flex flex-col">
